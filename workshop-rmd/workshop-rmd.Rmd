...
`intro_R_workshop`. It will then appear in the bottom right of RStudio as
`intro_R_workshop.R`.
...
> 5. What is a factor variable in R?\
> 6. How are string variables converted to factor variables?\
...
Reordering factor levels will come in handy when you need to rearrange your 
graphs of data.
